...
public class NinjaController {
    ...
    public void deletarNinjaPorId(@PathVariable Long id){  //Delete é instaciado como "void" pois não tem retorno algum de dado, ele apenas deleta por isso é simples
